        ...
        <div x-data="{ mobileMenuOpen: false }" class="flex flex-col md:pl-64">
            <div class="sticky top-0 z-10 flex flex-shrink-0 h-16 transition-all bg-white shadow dark:bg-gray-900">
                <button x-on:click="mobileMenuOpen = !mobileMenuOpen" type="button"
                        class="px-4 text-gray-500 border-r border-gray-200 transition-all dark:border-gray-800 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 md:hidden">
                ...
                <div class="flex justify-between flex-1 px-4">
                    ...
                    <div class="flex items-center ml-4 md:ml-6">
                        <button type="button"
                                class="p-1 text-gray-400 transition-all bg-white rounded-full dark:bg-gray-900 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
            ...
            <div class="relative z-40 md:hidden" role="dialog" aria-modal="true">
                ...
                <div :class="{ 'hidden': !mobileMenuOpen }"
                     class="fixed inset-0 top-16 bg-gray-600 bg-opacity-75"></div>
                ...
                <div :class="{ 'hidden': !mobileMenuOpen }" class="fixed inset-0 top-16 z-40 flex">
                    ...
                    -->
                    <div
                        class="relative flex flex-col flex-1 w-full max-w-xs pt-0 pb-4 bg-gray-100 border-gray-200 transition-all dark:bg-gray-800 border-t dark:border-gray-800">
                        <div class="flex-1 h-0 mt-5 overflow-y-auto">
                            <nav class="px-2 space-y-1">
                                <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                                <a href="#"
                                   class="flex items-center px-2 py-2 text-base font-medium text-black dark:text-white bg-gray-200 dark:bg-gray-900 transition-all rounded-md group">
                                    <!--
                                      Heroicon name: outline/home

                                      Current: "text-gray-300", Default: "text-gray-400 group-hover:text-gray-300"
                                    -->
                                    <svg class="flex-shrink-0 w-6 h-6 mr-4 text-black transition-all dark:text-gray-300"
                                ...
                                <a href="#"
                                   class="flex items-center px-2 py-2 text-base font-medium text-black dark:text-white transition-all rounded-md hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 dark:hover:text-white group">
                                    <!-- Heroicon name: outline/users -->
                                    <svg
                                        class="flex-shrink-0 w-6 h-6 mr-4 text-black transition-all dark:text-gray-400 dark:group-hover:text-gray-300"
                                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                              d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z"/>
            ...
            <main class="flex-1">
                <div class="py-6">
                    <div class="px-4 mx-auto max-w-7xl sm:px-6 md:px-8">
                        <h1 class="text-2xl font-semibold text-gray-900 transition-all dark:text-gray-100">
                            Dashboard</h1>
                    </div>
                    <div class="px-4 mx-auto max-w-7xl sm:px-6 md:px-8">
                        <h2 class="text-sm font-medium text-gray-500 transition-all dark:text-gray-400">Pinned
                            Projects</h2>
                        <ul role="list" class="grid grid-cols-2 gap-5 mt-3 sm:grid-cols-2 sm:gap-6 lg:grid-cols-5">
                            ...
                            <li class="flex col-span-1 rounded-md shadow-sm">
                                ...
                                <div
                                    class="flex items-center justify-between flex-1 truncate bg-white border-t border-b border-r border-gray-200 rounded-r-md">
                                    <div class="flex-1 px-4 py-2 text-sm truncate">
                                        <a href="#" class="font-medium text-gray-900 hover:text-gray-600">Component
                                            Design</a>
                            ...
                            <li class="flex col-span-1 rounded-md shadow-sm">
                                ...
                                <div
                                    class="flex items-center justify-between flex-1 truncate bg-white border-t border-b border-r border-gray-200 rounded-r-md">
                                    <div class="flex-1 px-4 py-2 text-sm truncate">
                                        <a href="#" class="font-medium text-gray-900 hover:text-gray-600">React
                                            Components</a>
